...
export const APP_UPDATES = [
  {
    ...
    date: "2026-09-07",
    summary: [
      "말하기 연습에서 브라우저 음성 인식 후보를 최대 세 개까지 따로 확인해 인식 실수로 인한 억울한 오답을 제한적으로 줄였습니다.",
      "첫 인식 결과가 정답과 아주 가까우면서 다른 후보가 정답 전체와 정확히 같을 때만 한 번 더 인정합니다.",
      "짧은 단어, 숫자 차이, 서로 다른 핵심 자음이 있는 단어와 three/tree 같은 혼동쌍은 계속 구분해 발음 연습 기준을 지킵니다.",
    ],
  },
  {
    version: "v1.15.0",
    date: "2026-09-07",
    summary: [
      "철자 게임의 오답·결과 모달을 좁은 화면에서도 끝까지 확인할 수 있도록 화면 레이어와 키보드 포커스를 보완했습니다.",
      "진행 중 정확도를 푼 문제 기준으로 안내하고, 힌트로 맞힌 문제와 세 번 틀려 정답이 공개된 문제를 결과에서 구분했습니다.",
      "빈 입력을 제출했을 때 기회를 줄이지 않고 바로 다시 쓸 수 있는 안내를 보여줍니다.",
    ],
  },
  {
    version: "v1.14.0",
  ...
  },
  {
    ...
    summary: [
      ...
      "긴 어구도 편하게 입력할 수 있도록 입력창을 넓히고, 입력 확인 버튼은 필요한 크기로 줄여 모바일에서도 균형 있게 보이도록 다듬었습니다.",
    ],
  },
  {
    version: "v1.13.0",
    date: "2026-08-20",
    summary: [
      "철자 완성 게임에 도움 계단형 힌트를 추가해 학생이 첫 단서부터 전체 철자까지 필요한 만큼 확인할 수 있게 했습니다.",
      "정답이 공개된 뒤에도 정답을 자동 입력하지 않고 학생이 직접 따라 쓰도록 하며, 힌트 사용은 기존 점수와 리더보드 저장 구조를 유지합니다.",
    ],
  },
  {
    version: "v1.12.3",
  ...
  },
  {
    ...
    date: "2026-07-13",
    summary: [
      "학급 빙고 학생 보드에서 첫 호출 단어를 체크할 때 순위 없음 값이 0으로 바뀌어 저장이 막히던 문제를 수정했습니다.",
      "첫 체크 전 빙고 순위는 null로 유지하고, 현재 호출 단어만 한 번 체크할 수 있는 기존 제한은 그대로 검증합니다.",
    ],
  },
  {
    version: "v1.11.0",
