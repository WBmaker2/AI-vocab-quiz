      ...
      <div className="bingo-join-grid">
        ...
        <article className="bingo-card bingo-join-instructions">
          ...
          <ol>
            ...
            <li>참여 후 1분 안에 영단어 카드를 내 빙고판에 직접 배치합니다.</li>
            <li>시간 안에 못 채운 칸은 컴퓨터가 자동으로 채워 줍니다.</li>
            <li>선생님이 부른 단어는 자동 체크되지 않고, 보드의 해당 칸을 직접 눌러야 합니다.</li>
            <li>3빙고 이후에도 선생님이 종료할 때까지 계속 이어서 진행됩니다.</li>
          </ol>
        </article>
      </div>
    </section>
